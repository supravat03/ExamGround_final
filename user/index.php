...
<html lang="en">
  ...
  <body>
    ...
    <div class="container-fluid">
      ...
      <li><a href="index.php?page=subject"><span class="glyphicon "><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-book-half" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
...
</svg></span> Subject</a></li>
      <li><a href="quiz"><span class="glyphicon "><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-layout-text-sidebar-reverse" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
  ...
  <path fill-rule="evenodd" d="M5 15V1H4v14h1zm8-11.5a.5.5 0 0 0-.5-.5h-5a.5.5 0 0 0 0 1h5a.5.5 0 0 0 .5-.5zm0 3a.5.5 0 0 0-.5-.5h-5a.5.5 0 0 0 0 1h5a.5.5 0 0 0 .5-.5zm0 3a.5.5 0 0 0-.5-.5h-5a.5.5 0 0 0 0 1h5a.5.5 0 0 0 .5-.5zm0 3a.5.5 0 0 0-.5-.5h-5a.5.5 0 0 0 0 1h5a.5.5 0 0 0 .5-.5z"/>
       ...
       <li><a href="index.php?page=notice"><span class="glyphicon"><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-receipt-cutoff" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
...
<li><a href="index.php?page=feedback"><span class="glyphicon glyphicon-thumbs-up"></span> Feedback</a></li>
      ...
      <ul style="font-size: 25px; text-align:left;">
        ...
        <li>
          To give Feedbacks for enrolled subjects Click on Feedback
        </li>
        <li>
          To give/view marks of quizzes Click on quiz
        </li>
        <li>
          To enroll or drop a subject Click on Subject
        </li>
        <li>
          To view the recieved notice's Click on Notice
        </li>
      </ul>
